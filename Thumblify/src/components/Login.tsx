    ...
    return (
        ...
        <div className='min-h-screen flex items-center justify-center relative z-10'>
             <form
                ...
                className="w-full sm:w-87.5 text-center bg-white/6 border border-white/10 rounded-2xl px-8 py-10 backdrop-blur-xl">
                <h1 className="text-white text-3xl font-medium">
                    {state === "login" ? "Login" : "Sign up"}
                </h1>

                <p className="text-gray-400 text-sm mt-2">
                    {state === "login" ? "Please sign in to continue" : "Create an account to start generating"}
                </p>
                ...
                <button type="submit" disabled={loading} className="mt-8 w-full h-11 rounded-full text-white bg-pink-600 hover:bg-pink-500 transition disabled:opacity-50" >
                ...
                <p onClick={() => setState(prev => prev === "login" ? "register" : "login")} className="text-gray-400 text-sm mt-3 cursor-pointer" >
