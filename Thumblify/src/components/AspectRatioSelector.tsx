import { RectangleHorizontal, RectangleVertical, RectangleVerticalIcon, Square } from 'lucide-react'
            ...
            <div className="flex flex-wrap gap-2">
                {aspectRatios.map((ratio)=>{
                    ...
                    return (
                        ...
                        className={`flex items-center gap-2 rounded-md border px-5 py-2.5 text-sm transition border-white/10 ${selected ? 'bg-white/10 border-pink-500/50' : 'hover:bg-white/6'} `}>
                            {iconMap[ratio]}
